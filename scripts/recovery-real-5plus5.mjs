...
import { codexSessionAdapter } from '../dist/src/products/packs/codex/sessions.js';
import { claudeSessionAdapter } from '../dist/src/products/packs/claude-code/sessions.js';
