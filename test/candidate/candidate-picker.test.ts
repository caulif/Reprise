...
test('running canvas uses the candidate product not the source session product', () => {
  const view = projectWorkbenchView({
    ...
    configDraft: { kind: 'openai-compatible', providerId: 'openai-compatible', modelId: 'gpt-5.6-terra', effort: 'medium', baseUrl: '', keyRef: '', api: 'openai-completions', reasoning: false, supportsImage: false },
    composer: '',
    composerCursor: 0,
    ...
    effort: 'medium',
    timeline: [{
      sequence: 1, occurredAt: '2026-08-11T00:10:00.000Z', source: 'TARGET',
      title: 'working', kind: 'live', placeholder: true, itemId: 'now:target', voice: 'candidate',
    }],
    visibleTimeline: [{
      sequence: 1, occurredAt: '2026-08-11T00:10:00.000Z', source: 'TARGET',
      title: 'working', kind: 'live', placeholder: true, itemId: 'now:target', voice: 'candidate',
