...
从[文档导航](./docs/README.md)的 **30 分钟路径**进入[产品定义](./docs/product/overview.md)、[架构总览](./docs/architecture/overview.md)与[日常开发](./docs/development.md)。`docs/tui-audit/frames/` 等列在导航的「不要读什么」里：它们是 **CI 门禁基线**，不是阅读材料。本地命令见[日常开发](./docs/development.md)；coding agent 先读 [AGENTS.md](./AGENTS.md)，再读任务直接相关的规范。
