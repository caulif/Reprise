...
const M = {
  ...
  originalRequest: { en: "Original request", zh: "原始请求" },
  headlineLabel: { en: "Main conclusion", zh: "主要结论" },
  sessionHistorical: { en: "Historical result", zh: "历史结果" },
  sessionCurrent: { en: "This run", zh: "本次结果" },
  sideHistorical: { en: "unrecorded", zh: "未记录" },
  sideCandidate: { en: "unrecorded", zh: "未记录" },
  candidateTaskCompleted: { en: "This run task status: completed", zh: "本次任务状态：已完成" },
  candidateTaskIncomplete: { en: "This run task status: incomplete ({code})", zh: "本次任务状态：未完成（{code}）" },
  candidateTaskOutcome: { en: "This run task status: {outcome}", zh: "本次任务状态：{outcome}" },
