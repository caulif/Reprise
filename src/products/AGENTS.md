...
改适配前读[兼容性规范](../../docs/architecture/product-plugin-compatibility.md)；历史读取、Projection 与 Playbook 的公共端口见 [contract.ts](contract.ts)，候选控制端口见 [core/runtime.ts](../core/runtime.ts)。
