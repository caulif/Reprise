...
[`DEFAULT_RUN_POLICY`](../../../src/application/default-run-policy.ts)（[workflow](../../../src/application/experiment-workflow.ts) 仅再导出）、[`CandidateRun`](../../../src/application/candidate-run.ts)、[架构总览](../../architecture/overview.md)。TUI 预计上限与默认政策一致。不改 Comparison resume，不改 Controller 决策语义。
