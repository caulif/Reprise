...
- 不替代 [可分享任务比较卡](./2026-09-09-comparison-shareable-task-card.md) 的产品目标；[视觉优先版式](../archive/accepted-2026-09/2026-09-19-comparison-visual-first-card.md) 的固定四区顺序由 [自主任务比较报告区与安全发布](./2026-09-19-comparison-autonomous-report-zones.md) 替代，Prompt 卡面合同见 [自主 Prompt 闭环](./2026-09-19-comparison-autonomous-prompt-loop.md)；本记录不改版式契约。
