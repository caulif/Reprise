...
- `test/application/artifact-renderer.test.ts`：fake 多帧、校验、取消、bundle 路径逃逸；opt-in 真浏览器双帧、HTTP/WebSocket、Worker·SW 与 WebRTC/STUN 出网阻断。
