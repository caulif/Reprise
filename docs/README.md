...
| Controller | [Controller](./architecture/controller.md) | [实验条件](./architecture/controller-experiment-conditions.md)、[开场不得引用未发生建议](./decisions/accepted/2026-09-16-controller-opening-no-unseen-advice.md) |
