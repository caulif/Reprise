...
| Controller | [协作行为与实验条件](./controller.md) | [Controller Agent](../../src/agents/controller-agent.ts)；连续 Session 先自由理解再决策，见[先理解再按视图决策](../decisions/accepted/2026-09-09-controller-understand-then-view.md) |
