...
| TUI | [当前界面](../product/tui.md)、[公开时间线](../decisions/accepted/2026-09-08-public-activity-timeline.md)、[阅读与终端](../decisions/accepted/2026-09-08-tui-reading-search-terminal.md)、[界面重构](./reprise-tui-surface-refactor.md) | 页图以 `product/tui.md` 为准。画布密度以[操作者画布](./reprise-tui-operator-canvas.md)与[此刻行](../decisions/accepted/2026-09-10-tui-live-now-row.md)为准。记录面实施顺序见[操作者记录面全面重构](./reprise-tui-operator-record-refactor.md)。真终端见[平台矩阵](./2026-09-08-platform-evidence-matrix.md) |
