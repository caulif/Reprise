...
| Controller | [Controller](../architecture/controller.md)、[先理解再按视图决策](../decisions/accepted/2026-09-09-controller-understand-then-view.md)、[协作协议](../decisions/accepted/2026-09-08-controller-collaboration-protocol.md) | 无独立 Understanding schema、无账本守卫；五族样例人工核对见 MASTER；真实模型 lane 须 `REPRISE_REAL_MODEL=1`，MiniMax 代表样例未全部匹配 |
...
| TUI | [当前界面](../product/tui.md)、[公开时间线](../decisions/accepted/2026-09-08-public-activity-timeline.md)、[阅读与终端](../decisions/accepted/2026-09-08-tui-reading-search-terminal.md)、[界面重构](./reprise-tui-surface-refactor.md) | 页图以 `product/tui.md` 为准。画布密度以[操作者画布](./reprise-tui-operator-canvas.md)与[此刻行](../decisions/accepted/2026-09-10-tui-live-now-row.md)为准。恢复、模拟用户与对照短句脊的目标见[内部 Agent Trace](./reprise-tui-recovery-trace.md)。记录面实施顺序见[操作者记录面全面重构](./reprise-tui-operator-record-refactor.md)。真终端见[平台矩阵](./2026-09-08-platform-evidence-matrix.md) |
| 模块所有权 | [代码层依赖](../../src/AGENTS.md)、[层门禁](../../scripts/verify-layer-imports.mjs) | 按所有者归组见[模块所有权](./reprise-module-ownership.md)；关闭看跨模块状态访问减少，不看文件数 |
